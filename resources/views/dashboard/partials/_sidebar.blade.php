<aside class="w-72 bg-[#1c212c] min-h-full h-screen flex-col items-center pt-5 pb-2 space-y-7 hidden md:flex lg:flex xl:flex">

    <!-- logo -->
    <div class="w-full flex items-center justify-items-start pl-3">
    ...
    <div class="w-full pr-3 flex flex-col gap-y-1 text-gray-500 fill-gray-500 text-sm">
        ...
        <div class="w-full flex items-center gap-x-1.5 group select-none">
            <div class="w-1 rounded-xl h-8 bg-transparent transition-colors duration-200 relative overflow-hidden">
                <div class="absolute top-0 left-0 w-full h-[102%] group-hover:translate-y-0 translate-y-0 bg-blue-600 transition-all duration-300"></div>
            </div>
            <div class="bg-white/10 text-white group-hover:bg-white/10 w-full group-active:scale-95 self-stretch pl-2 rounded flex items-center space-x-2 transition-all duration-200 dark:group-hover:text-white dark:hover:text-white text-sm" href="#">                    
                <svg class="h-5 w-5 !fill-blue-500 group-hover:fill-blue-600 dark:fill-gray-600  transition-colors duration-200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
